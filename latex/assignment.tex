...
\begin{figure}[htbp]
\centering
\includegraphics[width=\columnwidth]{ak.jpg}
\caption{ak.jpg}
\end{figure}.
...
\pagebreak
   ...
   \begin{enumerate}
       ...
       \begin{figure}[htbp]
\centering
\includegraphics[width=\columnwidth]{su.jpg}
\caption{su.jpg}
\end{figure}.
...
The picture given below, the kites flying together.
  \begin{figure}
\includegraphics[width=\columnwidth]{kite.jpg}
\caption{fig.5}
\end{figure}.
...
\begin{figure} 
	\includegraphics[width=1.1\columnwidth]{boat.edit.png}
\caption{figure6}
\label{fig6}
\end{figure}
